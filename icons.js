...
import { imagesOption } from './themes.js';
...
const randomize4x4images = () =>{

	let getData = imagesOption();
...
let ranImages4x4 = randomize4x4images();

let ranImages6x6 = randomize6x6images();
...
icons.onclick = function(){
  ...
  oneButton.onclick = function(){  /*single player game mode*/
   ...
   button4x4.onclick = function(){
     ...
     startbutton.onclick = function(){
      ...
      setupMenu.style.display = 'none';
       ...
       ranImages4x4.forEach((item, index)=>{

        var card = document.createElement('div');
        var fa_image = document.createElement('i');

       card.classList.add('card');
       gameInterface.classList.add('gridtemp_4x4');

       fa_image.setAttribute('class', item.image);
       card.setAttribute('name', item.name);
       
       card.append(fa_image);
...
}//end of fourplayer button


}//end of icon button mother button
